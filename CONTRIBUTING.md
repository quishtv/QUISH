Contributing to QUISH
============================

The QUISH project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/QUISH-project/QUISH/blob/master/doc/translation_process.md)
...
The following applies to code changes to the QUISH project, and is not to be
confused with overall QUISH Network Protocol consensus changes.

Whether a pull request is merged into QUISH rests with the project merge
...
Patches that change QUISH consensus rules are considerably more involved than
...
Where a patchset proposes to change the QUISH consensus, it must have been
...
The project leader is the release manager for each QUISH release.
