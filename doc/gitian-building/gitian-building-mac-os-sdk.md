...
The script [extract-osx-sdk.sh](https://github.com/QUISH-project/QUISH/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
QUISH/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/QUISH-project/QUISH/blob/master/doc/README_osx.md) for troubleshooting tips.
