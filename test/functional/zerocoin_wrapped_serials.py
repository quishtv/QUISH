...
from fake_stake.base_test import QUISH_FakeStakeTest

class zQTVwrappedSerialsTest(QUISH_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zQTVs..." % DENOM_TO_USE)
