...
from test_framework.QUISH_node import QUISHTestNode
...
class QUISH_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(QUISHTestNode())
