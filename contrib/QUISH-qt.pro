...
RESOURCES += src/qt/QUISH.qrc src/qt/QUISH_locale.qrc

TRANSLATIONS += src/qt/locale/QUISH_bg.ts \
                src/qt/locale/QUISH_de.ts \
                src/qt/locale/QUISH_en.ts \
                src/qt/locale/QUISH_es.ts \
                src/qt/locale/QUISH_fi.ts \
                src/qt/locale/QUISH_fr.ts \
                src/qt/locale/QUISH_it.ts \
                src/qt/locale/QUISH_ja.ts \
                src/qt/locale/QUISH_pl.ts \
                src/qt/locale/QUISH_pt.ts \
                src/qt/locale/QUISH_ru.ts \
                src/qt/locale/QUISH_sk.ts \
                src/qt/locale/QUISH_sv.ts \
                src/qt/locale/QUISH_vi.ts \
                src/qt/locale/QUISH_zh_CN.ts \
                src/qt/locale/QUISH_zh_TW.ts
