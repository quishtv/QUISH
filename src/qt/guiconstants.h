...
/* QUISH GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "QUISH"
#define QAPP_ORG_DOMAIN "QUISH.org"
#define QAPP_APP_NAME_DEFAULT "QUISH-Qt"
#define QAPP_APP_NAME_TESTNET "QUISH-Qt-testnet"
