...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(QTV);
    unitlist.append(mQTV);
    unitlist.append(uQTV);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case QTV:
        return QString("QUISH");
    case mQTV:
        return QString("mQUISH");
    case uQTV:
        return QString::fromUtf8("uQUISH");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case QTV:
            return QString("tQTV");
        case mQTV:
            return QString("mtQTV");
        case uQTV:
            return QString::fromUtf8("μtQTV");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case QTV:
            return QString("QTV");
        case mQTV:
            return QString("Milli-QTV (1 / 1" THIN_SP_UTF8 "000)");
        case uQTV:
            return QString("Micro-QTV (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case QTV:
            return QString("TestQTVs");
        case mQTV:
            return QString("Milli-TestQTV (1 / 1" THIN_SP_UTF8 "000)");
        case uQTV:
            return QString("Micro-TestQTV (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
