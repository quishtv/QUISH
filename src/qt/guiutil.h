...
/** Utility functions used by the QUISH Qt UI.
 */
namespace GUIUtil
{
...
// Render QUISH addresses in monospace font
...
// Parse "QUISH:" URI into recipient object, return true on successful parsing
