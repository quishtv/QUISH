...
#include "qt/QUISH/coldstakingwidget.h"
#include "qt/QUISH/forms/ui_coldstakingwidget.h"
#include "qt/QUISH/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/QUISH/requestdialog.h"
#include "qt/QUISH/tooltipmenu.h"
...
ColdStakingWidget::ColdStakingWidget(QUISHGUI* parent) :
    PWidget(parent),
	...
	isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your QTVs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept QTV delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select QTV outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 QTV" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
