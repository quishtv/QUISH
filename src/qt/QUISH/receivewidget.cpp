...
#include "qt/QUISH/forms/ui_receivewidget.h"
...
#include "qt/QUISH/addressholder.h"
...
ReceiveWidget::ReceiveWidget(QUISHGUI* parent) :
	PWidget(parent),
	ui(new Ui::ReceiveWidget)
{
	...
	ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive QTV."));
