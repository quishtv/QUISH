...
#include "qt/QUISH/settings/settingssignmessagewidgets.h"
#include "qt/QUISH/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(QUISHGUI* _window, QWidget *parent) :
