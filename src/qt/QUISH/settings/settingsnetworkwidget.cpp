...
#include "qt/QUISH/settings/settingsnetworkwidget.h"
#include "qt/QUISH/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/QUISH/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(QUISHGUI* _window, QWidget *parent) :
