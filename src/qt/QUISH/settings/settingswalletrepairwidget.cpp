...
#include "qt/QUISH/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/QUISH/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(QUISHGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to QUISHGUI::handleRestart()
