...
#include "qt/QUISH/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/QUISH/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(QUISHGUI* _window, QWidget *parent) :
