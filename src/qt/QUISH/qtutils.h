...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, QUISHGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, QUISHGUI *gui, double posX = 3);
