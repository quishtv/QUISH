...
#include "qt/QUISH/coincontrolQTVwidget.h"
#include "qt/QUISH/forms/ui_coincontrolQTVwidget.h"

CoinControlQTVWidget::CoinControlQTVWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlQTVWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select QTV Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("QTV");
    ...
    ui->labelValueAfter->setText("0.00 QTV");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 QTV");
    ui->labelValueFee->setText("0.00 QTV");
...
CoinControlQTVWidget::~CoinControlQTVWidget()
{
    delete ui;
}
