...
#include "qt/QUISH/pwidget.h"
#include "qt/QUISH/furabstractlistitemdelegate.h"
#include "qt/QUISH/txviewholder.h"
#include "qt/QUISH/tooltipmenu.h"
#include "qt/QUISH/sendmultirow.h"
#include "qt/QUISH/coldstakingmodel.h"
#include "qt/QUISH/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(QUISHGUI* parent);
    ~ColdStakingWidget();
