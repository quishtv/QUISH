...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("QUISH QUISH-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  QUISH-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded QUISH transaction") + "\n" +
                               "  QUISH-tx [options] -create [commands]   " + _("Create hex-encoded QUISH transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded QUISH transaction
