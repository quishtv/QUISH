...
#ifndef QUISH_INVALID_SERIALS_JSON_H
#define QUISH_INVALID_SERIALS_JSON_H
...
std::string LoadInvalidSerials()
{
    std::string str = "[\n"
            ...
            "  },\n"
            "  {\n"
            "    \"s\": \"895f69760174853b31478fb13b209f68cdf01720bb1a1c298fa42474a6f46958\"\n"
            "  },\n"
            "  {\n"
...
#endif //QUISH_INVALID_SERIALS_JSON_H
