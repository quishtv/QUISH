...
#ifndef QUISH_ZQTVWALLET_H
#define QUISH_ZQTVWALLET_H
...
public:
    CzQTVWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZQTV(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZQTV(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
