...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* QUISH features */
        {"QUISH", "listmasternodes", &listmasternodes, true, true, false},
        {"QUISH", "getmasternodecount", &getmasternodecount, true, true, false},
        {"QUISH", "masternodeconnect", &masternodeconnect, true, true, false},
        {"QUISH", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"QUISH", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"QUISH", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"QUISH", "masternodecurrent", &masternodecurrent, true, true, false},
        {"QUISH", "masternodedebug", &masternodedebug, true, true, false},
        {"QUISH", "startmasternode", &startmasternode, true, true, false},
        {"QUISH", "createmasternodekey", &createmasternodekey, true, true, false},
        {"QUISH", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"QUISH", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"QUISH", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"QUISH", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"QUISH", "getmasternodescores", &getmasternodescores, true, true, false},
        {"QUISH", "preparebudget", &preparebudget, true, true, false},
        {"QUISH", "submitbudget", &submitbudget, true, true, false},
        {"QUISH", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"QUISH", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"QUISH", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"QUISH", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"QUISH", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"QUISH", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"QUISH", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"QUISH", "checkbudgets", &checkbudgets, true, true, false},
        {"QUISH", "mnsync", &mnsync, true, true, false},
        {"QUISH", "spork", &spork, true, true, false},
        {"QUISH", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> QUISH-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1719/\n";
}
